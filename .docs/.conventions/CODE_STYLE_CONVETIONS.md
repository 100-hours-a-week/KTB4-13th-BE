...
- 포맷은 Google의 레거시 Eclipse JDT 프로필에서 출발한 프로젝트 설정을 Spotless로 적용합니다. 프로젝트 규칙인 4칸 들여쓰기와 140자 줄 길이가 기본 가이드보다 우선합니다.
...
- 각 Java 소스 줄의 길이는 140자 이내로 제한합니다. `./gradlew check`가 초과 줄을 검사합니다.
