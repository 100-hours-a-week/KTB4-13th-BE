...
public interface AuthControllerSpec {
    @Operation(summary = "소셜 로그인", description = "외부 provider ID Token으로 로그인하고 서비스 Token을 발급합니다.")
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "로그인 성공",
        ...
        @ApiResponse(responseCode = "401", description = "유효하지 않은 provider ID Token")
    })
